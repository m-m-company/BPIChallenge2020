...
if __name__ == '__main__':
    ...
    print("national declaration throughput = ", avgThr(domesticDF))
    print("international declaration throughput = ", avgThr(internationalDFFiltered))
    print("international declaration throughput = ", avgThr(internationalDF))
    print("national declaration + international declaration throughput = ", avgThr(globalDF))
